...
def Add_developers(file):
    ...
    with open(file,'r') as infile:
        ...
        for i in data:
            ...
            os.system("sudo adduser -s /usr/bin/csh -G developers %s" %uid)
    ...
    with open(file,'r') as infile:
        ...
        for i in data:
            ...
            if ((len(names)) >=3 ):
                ...
                Lastname= names[-1]
                uid = First_Int+Midel_Int+Lastname
            os.system("sudo adduser -G admin %s" %uid)
            #here we add the users the while group
            os.system("sudo usermod -aG wheel %s" %uid)
    ...
    with open(file,'r') as infile:
        ...
        for i in data:
            ...
            if ((len(names)) >=3 ):
                ...
                Lastname= names[-1]
                uid = First_Int+Midel_Int+Lastname
            os.system("sudo adduser -G staff %s" %uid)
    ...
    with open(file,'r') as infile:
        ...
        for i in data:
            ...
            if ((len(names)) >=3 ):
                ...
                Lastname= names[-1]
                uid = First_Int+Midel_Int+Lastname
            os.system("sudo adduser -G temp %s" %uid)
